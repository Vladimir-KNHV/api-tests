...
class ExercisesClient(APIClient):
    ...
    def get_exercises_api(self, query: GetExercisesQuerySchema) -> Response:
        ...
        """
        return self._get(APIRoutes.EXERCISES, params=query.model_dump(by_alias=True))
    ...
    def get_exercise_api(self, exercise_id: str) -> Response:
        ...
        :return: Ответ от сервера в виде объекта httpx.Response
        """
        return self._get(f'{APIRoutes.EXERCISES}/{exercise_id}')
    ...
    def create_exercise_api(self, request: CreateExerciseRequestSchema) -> Response:
        ...
        :return: Ответ от сервера в виде объекта httpx.Response
        """
        return self._post(APIRoutes.EXERCISES, json=request.model_dump(by_alias=True))
    ...
    def update_exercise_api(self, exercise_id: str, request: UpdateExerciseRequestSchema) -> Response:
        ...
        :return: Ответ от сервера в виде объекта httpx.Response
        """
        return self._patch(f'{APIRoutes.EXERCISES}/{exercise_id}', json=request.model_dump(by_alias=True, exclude_none=True))
    ...
    def delete_exercise_api(self, exercise_id: str) -> Response:
        ...
        :return: Ответ от сервера в виде объекта httpx.Response
        """
        return self._delete(f'{APIRoutes.EXERCISES}/{exercise_id}')
