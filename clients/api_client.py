...
class APIClient:
    ...
    def _get(self, url: URL | str, params: QueryParams | None = None) -> Response:
        """
    ...
    def _patch(self, url: URL | str, json: Any | None = None) -> Response:
        """
    ...
    def _delete(self, url: URL | str) -> Response:
        """
